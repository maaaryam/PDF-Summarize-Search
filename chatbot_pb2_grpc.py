...
class ChatbotServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.SendPDFPaths = channel.unary_unary(
                '/chatbot.ChatbotService/SendPDFPaths',
                request_serializer=chatbot__pb2.PDFPathsRequest.SerializeToString,
                response_deserializer=chatbot__pb2.PDFPathsResponse.FromString,
...
def add_ChatbotServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendPDFPaths': grpc.unary_unary_rpc_method_handler(
                    servicer.SendPDFPaths,
                    request_deserializer=chatbot__pb2.PDFPathsRequest.FromString,
                    response_serializer=chatbot__pb2.PDFPathsResponse.SerializeToString,
            ),
...
class ChatbotService(object):
    ...
    def SendPDFPaths(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/chatbot.ChatbotService/SendPDFPaths',
            chatbot__pb2.PDFPathsRequest.SerializeToString,
            chatbot__pb2.PDFPathsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
